%UKF_PREDICT1 UKF prediction step
%
% Syntax:
%   [x,P] = UKF_PREDICT1(x,P,f,Q,f_param,alpha,beta,kappa,mat)
%
% In:
...
%
% Description:
%   Perform additive, non augmented form of Unscented Kalman Filter prediction step.
%
% See also:
%   UNSCENTEDTRANSFORMATION, CALCWEIGHTS, CALCWEIGHTSMATRIX,
%   CALCSIGMAPOINTS
